                  ...
                  child: Container(
                    ...
                    child: (dateTime.weekday+dayIndex -1)%7 == 6
                        ...
                        : ListView.builder(
                            ...
                            itemCount: mca.semesters[0].timetable[(dateTime.weekday+dayIndex -1)%7].slots.length,
                            itemBuilder: (context, index) {
                              var slot = mca.semesters[0].timetable[(dateTime.weekday+dayIndex -1)%7].slots[index];
